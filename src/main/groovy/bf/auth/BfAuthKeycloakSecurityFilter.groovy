...
public class BfAuthKeycloakSecurityFilter implements Filter {
    ...
    public static void importKeycloakSecurityContext(KeycloakSecurityContext kcContext) {
...
*/
        ...
        ec.service.sync().name("createOrAttachAccount").parameters(svcContext);
    }
